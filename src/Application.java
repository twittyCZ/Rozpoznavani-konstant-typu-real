...
public class Application extends javafx.application.Application {
     ...
     */
    private static final String DONE_MESSAGE = "Automat je v konečném stavu, nelze vložit další symbol.";
    /**
     * Message to user, when maschine has come to error state.
     */
    private static final String ERROR_MESSAGE = "Tato akce spadá do chybového stavu. Prosím zadejte validní symbol.";
    /**
     * States in the graph
     */
    private static State startState, signState, intState,  decState, floatState, eState, signEState, endState,
            expState, dontKnowState;
    /**
     * Array of all states
     */
    ...
    private static Transition xToStartByNothingTransition, startToSignByPlusTransition, startToSignByMinusTransition,
            ...
            expToEndTransition, endToDoneTrasition;
    /**
    ...
    public void start(Stage stage) throws IOException {
        ...
        states = new State[]{startState, signEState, intState, eState,  decState, floatState, signState,
                endState, dontKnowState, expState};
        ...
        , expToExpByNumberTransition, startToDontKnowByCommaTransition, signToDontKnowByCommaTransition, dontKnowToFloatByNumberTransition,
                decToEndTransition,floatToEndTransition, expToEndTransition,endToDoneTrasition};

        Scene scene = new Scene(root, 1280, 640);
        stage.setTitle("TI Semestrální práce - Tomáš Vítek");
    ...
    private void addEnd() {
        if (endState.isActual()) {
            Alert alert = new Alert(Alert.AlertType.WARNING, DONE_MESSAGE);
        ...
        if(expState.isActual()){
            ...
            Alert alet = new Alert(Alert.AlertType.INFORMATION, "Řetězec přijat!");
            alet.showAndWait();
            ...
            Alert alert = new Alert(Alert.AlertType.WARNING, ERROR_MESSAGE);
            alert.showAndWait();
